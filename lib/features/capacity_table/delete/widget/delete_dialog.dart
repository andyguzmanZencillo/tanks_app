...
class DeleteCapacityTableDialog extends StatelessWidget {
  const DeleteCapacityTableDialog({
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<DeleteCapacityTableCubit>(),
      child: Builder(
        builder: (context) {
          final cubit = context.read<DeleteCapacityTableCubit>();
          return Dialog(
            child: Stack(
              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 16),
                      Text(
                        'Nombre: ${consoleEntity.alturaTanque}',
                        style: const TextStyle(fontWeight: FontWeight.bold),
                      ),
                      Text('Descripción: ${consoleEntity.volumen}'),
                      const SizedBox(height: 24),
                      BlocSelector<DeleteCapacityTableCubit,
                          DeleteCapacityTableState, DeleteStatus>(
                        ...
                        builder: (context, state) {
                          ...
                          return Row(
                            ...
                            children: [
                              ...
                              TextButton(
                                onPressed: () {
                                  cubit.delete(consoleEntity.idTanque);
                                },
                                child: isLoading
                ...
                BlocSelector<DeleteCapacityTableCubit, DeleteCapacityTableState,
                    DeleteStatus>(
                  selector: (state) => state.deleteStatus,
                  builder: (s, c) {
