...
class DeleteConfigDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<DeleteConfigCubit>(),
      child: Builder(
        builder: (context) {
          final cubit = context.read<DeleteConfigCubit>();
          return Dialog(
            child: Stack(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 16),
                      Text(
                        'Nombre: ${configEntity.horaInicioZeta}',
                        style: const TextStyle(fontWeight: FontWeight.bold),
                      ),
                      Text('Descripción: ${configEntity.horaFinZeta}'),
                      const SizedBox(height: 24),
                      BlocSelector<DeleteConfigCubit, DeleteConfigState,
                          DeleteStatus>(
                        ...
                        builder: (context, state) {
                          ...
                          return Row(
                            ...
                            children: [
                              ...
                              TextButton(
                                onPressed: () {
                                  cubit.delete(configEntity.idConfiguracion);
                                },
                                child: isLoading
