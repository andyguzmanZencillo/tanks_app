...
class DeleteTanksDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<DeleteTanksCubit>(),
      child: Builder(
        builder: (context) {
          final cubit = context.read<DeleteTanksCubit>();
          return Dialog(
            child: Stack(
              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 16),
                      Text(
                        'Nombre: ${consoleEntity.descripcion}',
                        style: const TextStyle(fontWeight: FontWeight.bold),
                      ),
                      Text('Descripción: ${consoleEntity.descripcion}'),
                      const SizedBox(height: 24),
                      BlocSelector<DeleteTanksCubit, DeleteTanksState,
                          DeleteStatus>(
                ...
                BlocSelector<DeleteTanksCubit, DeleteTanksState, DeleteStatus>(
                  selector: (state) => state.deleteStatus,
                  builder: (s, c) {
